...
void drawScene() {
	...
	GLfloat lightPos[] = {-1.5f * RADIUS, -2 * RADIUS, 1.5f * RADIUS, 1.0f};
	...
	GLfloat lightPos1[] = {1.5f * RADIUS, -2 * RADIUS, 1.5f * RADIUS, 1.0f};
	//Diffuse (non-shiny) light component
	...
	GLfloat lightPos2[] = {1.5f * RADIUS, 2 * RADIUS, 1.5f * RADIUS, 1.0f};
	//Diffuse (non-shiny) light component
